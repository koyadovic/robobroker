...
def _discriminate_by_sell_and_purchase():
    ...
    for currency in trading_cryptocurrencies:
        ...
        if current_sell_price > sell_prices_median + sell_prices_stdev and last_6h_profit < 0:
        ...
        if current_buy_price < buy_prices_median - buy_prices_stdev and last_6h_profit > 0:
